...
def openai_on_input_handler(
    func: Op, args: list, kwargs: dict
) -> Optional[ProcessedInputs]:
    # print("openai_on_input_handler")
    # print(args)
    # print(kwargs)
    if len(args) == 2 and isinstance(args[1], weave.Prompt):
        original_args = args
    ...
    # TODO: Handle case where messages parameter is a Prompt
    return None
